...
import chris from "../../images/ify.jpg";
  ...
  return (
    <div>
      ...
      <div className="company_section-1">
        ...
        <h2>Our Company</h2>
        <p>
          At PacePharmaCare, we deliver solutions that make life and living a
          pleasurable experience. We provide products that cover every age and
          gender.
        </p>
      </div>
      <Container fluid className="cmpnypgcontainer">
        <div className="compny_section-2">
          ...
          <h1 className="heading_secondary">
            Our Mission is to deliver healthcare products that make life and
            living a pleasurable experience .{" "}
          </h1>
          <p className="compnypgcontent">
            We partner with global pharmaceutical companies to provide medicines
            that improve the quality of life of people across Africa and at an
            affordable cost. We recognise that the journey to healthy living
            starts with daily choices. Our goal is to provide pharmaceutical
            options that make quality living a reality to people across Africa.
            Our intervention point starts from preventive care through our broad
            range of Supplements. We also provide healthy options for an
            improved sexual life for both men and women. Beyond these, we are
            constantly scouting the world to establish partnerships that deliver
            medicines to the people of Africa. This is our journey, and we are
        ...
        <div className="companyteamwrap">
          ...
          <div className="companyteamcontentwrap">
            <p className="compnypgcontent">
              PacePharmaCare is led by a group of seasoned professionals with
              experience in healthcare and other diverse fields of human
              endeavour. The diversity of the leadership team ensures that we
              are able to address every aspect of our business with balanced
            ...
            <div className="modalheadersection">
              ...
              <div className="modalheadersection_col2">
                <p>
                  ...
                  Doctor of Engineering (D.Eng. Honoris Causa) from University of Uyo in 2017.
                </p>
              </div>
            </div>
            <p className="modalparagph">
              DR. Kevin started his career in the Oil
              and Gas industry as a Facilities Engineer in 1997. He held several
              technical, Planning, Supervisory, production operations,
              Maintenance managerial, Safety and leadership positions in Novas
              Scotia Canada, Houston Texas USA and other African countries
              covering Angola, Equatorial Guinea, Nigeria and Chad. Kevin is a
              member and Fellow of various professional bodies; Fellow, Nigerian
              Society of Engineers and member of the Council for the Regulation
              of Engineering in Nigeria Fellow, Institute of Safety
              Professionals of Nigeria (ISPON) Member, Nigerian Society of
              Petroleum Engineers (SPE) Kevin has served the Nigeria Society of
              Engineers (NSE) under several capacities both at the National,
        ...
        >
          <div className="modalbody">
            ...
            <div className="modalheadersection">
              ...
              <div className="modalheadersection_col2">
                <p>
                  <strong>Pharm. Ifeyinwa Iheanacho</strong> is a seasoned
                  pharmacist with about 20 years post qualification experience.
                  Ifeyinwa graduated from the College of medicine, University of
                  Lagos with a B.Pharm in 2000. She obtained her FPCPharm
                  certificate in 2020 from the West African Post Graduate
                  College of Pharmacy.
                </p>
              </div>
            </div>
            <p className="modalparagph">
              Ifeyinwa’s career experience has seen her excel in many leading
              pharmaceutical organisations and health institutions across
              Nigeria. Beyond her role at Pace Pharmacare, Ifeyinwa doubles in a
              leadership role in one of the most prestigious teaching hospitals
              in Nigeria.
            </p>
            <p className="modalparagph">
              Ifeyinwa is an advocate of preventive medicine. She is passionate
              about delivering quality and affordable healthcare to people
              across Africa. Through her leadership role at Pace Pharma Care,
              Ifeyinwa continues to make a difference as a vanguard of
              responsible medicine and healthy living.
            </p>
          </div>
        </Modal>
        <Modal
        ...
        <div className="compnypgdirectorswrap">
          ...
          <div className="compnydirectorcards">
            ...
            <p className="cmpnydirectorname" onClick={ruthsModal}>
              <img src={arrowright} /> Iheanacho ifeyinwa Christy{" "}
              <img src={arrowleft} />
            </p>
            <p className="directorpostion">Chief Pharmacist</p>
          </div>
          <div className="compnydirectorcards">
        ...
        <div className="team_section">
          <h6 className="heading_tertiary">
            <img src={arrowright} /> Our Office in Pictures{" "}
            <img src={arrowleft} />{" "}
          </h6>
